...
const options = {
    ...
    headers: {
        ...
        Authorization: "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI1ZGFhNDdjNWFmMmZiZTI5ZTQ0N2JlNDUwOTZjZjM5NSIsInN1YiI6IjY1OWE2NTZhN2Q1NTA0MDIwMzBiMWY4NSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.VZs4CBydjbnWA492WyXRqTF4GJrfSUF4W6JAXo_LNlU"
    }
};

const dbUrl = "https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=1";
...
fetchData(dbUrl)
    .then(dataArray => {
        ...
        let movie_poster = 'https://image.tmdb.org/t/p/original'
        let obj = [dataArray['results']]
        let MovieCards = []
        for (let i = 0; i < obj.length; i++) {
            ...
            container.addEventListener("click", e => alert('영화 ID :'+ e.target.closest('.movieCards').id));
            ...
            search_btn.addEventListener("click", (e) => {
                e.preventDefault();
                container.innerHTML = '';
                let search_value = search_input.value.toUpperCase();
